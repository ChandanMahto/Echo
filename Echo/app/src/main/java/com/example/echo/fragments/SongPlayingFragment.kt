...
class SongPlayingFragment : Fragment() {
    ...
    object Staticated {
        ...
        fun processInformation(mediaPlayer: MediaPlayer) {
            ...
            android.os.Handler().postDelayed(Statified.updateSongTime, 1000)
            ...
            Statified.seekbar?.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
                ...
                override fun onStopTrackingTouch(seekBarget: SeekBar?) {
                    ...
                    mediaPlayer?.seekTo(Statified.seekbar?.getProgress() as Int)
                }
            })
        ...
        fun playNext(check: String) {
            if (check.equals("PlayNextNormal", false)) {
