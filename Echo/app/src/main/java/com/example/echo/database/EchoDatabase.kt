...
class EchoDatabase:SQLiteOpenHelper{
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        db?.execSQL("CREATE TABLE "+Staticated.TABLE_NAME+"( "+Staticated.COLUMN_ID+" INTEGER,"+Staticated.COLUMN_SONG_ARTIST+" STRING,"
    ...
    fun storeasFavorite(id:Int?,artist:String?,songTitle:String?,path:String?){
        ...
        dbase.insert(Staticated.TABLE_NAME,null,contentValues)
        dbase.close()
    }
